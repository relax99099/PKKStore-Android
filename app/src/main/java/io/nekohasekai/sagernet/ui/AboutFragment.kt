                            ...
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/MatsuriDayo/PKKStoreForAndroid/releases"
                                    )
                                }
                                .build())
                        .addItem(
                    ...
                    MaterialAboutCard.Builder()
                        ...
                        .addItem(
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/MatsuriDayo/PKKStoreForAndroid"
            ...
            runOnIoDispatcher {
                try {
                    ...
                    val response = client.newRequest().apply {
                        if (checkPreview) {
                            setURL("https://api.github.com/repos/MatsuriDayo/PKKStoreForAndroid/releases/tags/preview")
                        } else {
                            setURL("https://api.github.com/repos/MatsuriDayo/PKKStoreForAndroid/releases/latest")
                        }
                    }.execute()
